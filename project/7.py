...
# Висновок:
# Метод Монте-Карло дає результати, які близькі до аналітичних значень.
# Найбільш імовірна сума - 7, а найбільш рідкісні - 2 і 12.
# Результати підтверджують класичні ймовірності для кидків двох